...
#NEW FOR OUR DB REFLECTION

class Artist(db.Model):
    __table__ = db.Model.metadata.tables['Artist_T']

class Art_Mediums(db.Model):
    __table__ = db.Model.metadata.tables['ArtMediums_T']

class Art_Work(db.Model):
    __table__ = db.Model.metadata.tables['ArtWork_T']

class Era(db.Model):
    __table__ = db.Model.metadata.tables['Era_T']

class Medium(db.Model):
    __table__ = db.Model.metadata.tables['Medium_T']
